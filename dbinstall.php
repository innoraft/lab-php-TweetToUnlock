...
mysql_query("CREATE TABLE IF NOT EXISTS users(user_id TEXT NOT NULL, user_name TEXT NOT NULL, last_tweet_time TEXT NOT NULL, t_count INT(2) NOT NULL, PRIMARY KEY(user_id))") or die(mysql_error()); //change the table names
mysql_query("CREATE TABLE IF NOT EXISTS donated_items(item_id INT(11) NOT NULL AUTO_INCREMENT, name TEXT NOT NULL, description TEXT, donated INT(11) DEFAULT 0, image VARCHAR(255) NOT NULL, PRIMARY KEY(item_id))") or die(mysql_error());
